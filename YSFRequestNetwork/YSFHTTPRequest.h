...
@class YSFHTTPRequestResult;
/**
 请求成功的block
 */
typedef void(^YSFRequestSuccess)(YSFHTTPRequestResult *result);
typedef void(^YSFRequestSuccessAndCache)(YSFHTTPRequestResult *result,BOOL isCache);
/**
 请求失败的block
 */
...
@interface YSFHTTPRequestResult : NSObject
...
@interface YSFHTTPRequest : NSObject
#pragma mark - 登陆退出
/** 登录*/
/*
